...
ART-009: Guard activation smoke
  type: config
  path: .github/workflows/loom-writeback-guard.yml
  owner: human+copilot
  created: 2026-02-13
...
ART-010: 24x7 Loom watchdog automation
  type: config
  path: .github/workflows/loom-24x7-watchdog.yml, scripts/loom_watchdog.py
  owner: human+copilot
  created: 2026-02-13
  status: active
  notes: Scheduled watchdog runs every 30 minutes and opens issue on failure.
